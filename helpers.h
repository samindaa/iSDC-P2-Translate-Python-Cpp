...
*/
std::vector<std::vector<float> > blur(const std::vector<std::vector<float> > &grid,
                                      float blurring);
...
*/
bool close_enough(const std::vector<std::vector<float> > &g1,
                  const std::vector<std::vector<float> > &g2);
